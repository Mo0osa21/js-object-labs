...
*/
const pokemon1 = pokemon[5]
const pokemon2 = pokemon[6]
const pokemon3 = pokemon[12]
game.party.push(pokemon1)
game.party.push(pokemon2)
game.party.push(pokemon3)
console.log(game)
...
game.gyms.forEach((gym) => {
  if (gym.difficulty === 'Easy' || gym.difficulty === 'Med') {
    gym.completed = true
  }
  console.log(game)
})
